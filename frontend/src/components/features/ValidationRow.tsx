    ...
    return (
        <div className="bg-gray-800 p-4 rounded-lg border border-gray-700 mb-3 hover:border-gray-600 transition-colors">
            ...
            <div className="grid grid-cols-2 gap-3 mb-3">
                <div>
                    <label className="block text-xs text-gray-400 mb-1">Preço Total</label>
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full bg-gray-900 border border-gray-700 rounded px-2 pl-7 py-1 text-sm text-white focus:outline-none focus:border-primary"
                            step="0.01"
                        />
                    </div>
                </div>
