...
export function Button({
    ...
    const variants = {
        primary: 'bg-primary text-text-primary hover:bg-emerald-600 focus:ring-primary',
        secondary: 'bg-surface-alt text-text-primary hover:bg-gray-600 focus:ring-gray-500',
